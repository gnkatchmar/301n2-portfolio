var rawData = [
  ...
  },
  {
    ...
    lastMod:     '2016-02-18',
    body:        '<p>From February 2015 through February 2016, I participated in the Code Oregon 1.0/Treehouse program. </p><img src="images/Badges01.jpg" class="pull-left">Per their website, "As you progress through Tracks and the Library, you\'ll earn points for completing videos and quizzes and earn badges for bigger accomplishments. Show off your badges on your own sites and apps!"</p><p> I earned 10,906 points and 128 badges in JavaScript, Development Tools, HTML, PHP, CSS and Python (in order of points awarded).</p>'
  },
];
